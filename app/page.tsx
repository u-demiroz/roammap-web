      ...
      <main style={{ maxWidth: 640, margin: "0 auto", padding: "80px 32px", textAlign: "center" }}>
        <motion.div initial={{ y: 30, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.7 }}>
          ...
          <h1 style={{ fontSize: "clamp(2rem, 6vw, 3.5rem)", fontWeight: 900, color: "#fff", lineHeight: 1.1, marginBottom: 20 }}>
            Your World,<br />
            <span style={{ color: "#6366f1" }}>Mapped & Shared</span>
          </h1>
          <p style={{ fontSize: 18, color: "#94a3b8", lineHeight: 1.7, marginBottom: 40 }}>
            Save places you love, discover new spots, and share your world with friends. Your personal travel map, always in your pocket.
          </p>
          <a
            href="https://apps.apple.com/us/app/roam-map/id6761302186"
            target="_blank"
        ...
        >
          {[
            { emoji: "📍", title: "Save Places", desc: "Bookmark any spot on the map" },
            { emoji: "👥", title: "Social Feed", desc: "See where friends have been" },
            { emoji: "📋", title: "Lists", desc: "Organize places into lists" },
            { emoji: "✈️", title: "Trips", desc: "Plan and share your trips" },
          ].map((f) => (
